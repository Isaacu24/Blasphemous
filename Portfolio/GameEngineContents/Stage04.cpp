...
void Stage04::Update(float _DeltaTime)
{
	...
	if (2300 < CameraActor_->GetTransform().GetLocalPosition().x)
	{
		CameraActor_->GetTransform().SetWorldPosition(float4{ 2300, CameraActor_->GetTransform().GetLocalPosition().y });
	}
